...
class Player:
    ...
    def render(self) -> None:
        view_x, view_y = self.character.position.position
        for y in range(view_y-self.height//2,view_y+self.height//2):
            for x in range(view_x-self.width//2,view_x+self.width//2):
